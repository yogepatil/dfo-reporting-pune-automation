...
SELECT VIS_ID as src_visitEventid,
       ...
       s.VISIT_DESTINATION_ID AS src_visitDestinationId,
       t.VISIT_DESTINATION_ID AS trg_visitDestinationId,
       CASE
         WHEN src_visitDestinationId = trg_visitDestinationId THEN true
         ELSE false
       END AS flag
FROM   src s
       INNER JOIN tgt t
