...
class TestFromArrays(Base):
    """TEST specific to IntervalIndex.from_arrays"""
...
class TestFromBreaks(Base):
    """TEST specific to IntervalIndex.from_breaks"""
...
class TestFromTuples(Base):
    """TEST specific to IntervalIndex.from_tuples"""
...
class TestClassConstructors(Base):
    """TEST specific to the IntervalIndex/Index constructors"""
