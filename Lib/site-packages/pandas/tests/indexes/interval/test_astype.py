...
class Base:
    """TEST common to IntervalIndex with any subtype"""
...
class TestIntSubtype(Base):
    """TEST specific to IntervalIndex with integer-like subtype"""
...
class TestFloatSubtype(Base):
    """TEST specific to IntervalIndex with float subtype"""
...
class TestDatetimelikeSubtype(Base):
    """TEST specific to IntervalIndex with datetime-like subtype"""
