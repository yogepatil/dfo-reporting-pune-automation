# @Author  : Yogesh Patil
# @Date    : 22/08/2023
# @File    : test_021_DAT_11256_Digital_Foundation_Non_Agent_billing.py
...
def test_billing_data_added_correctly_in_metered_daily_usage_fact_table_for_digi_foundation_non_agent():
    registration_type = 'REFINED'
    table_name = 'DIGI_FOUNDATION_NON_AGENT_BILLING'
    field_name = 'DIGI_FOUNDATION_NON_AGENT_BILLING_DATA'
...
def test_metered_quantity_received_only_once_for_a_tenant_in_metered_daily_usage_fact_for_digi_foundation_non_agent():
    registration_type = 'REFINED'
    table_name = 'DIGI_FOUNDATION_NON_AGENT_BILLING'
...
def test_metered_quantity_is_not_null_in_metered_daily_usage_fact_table_for_digi_foundation_non_agent():
    registration_type = 'REFINED'
    table_name = 'DIGI_FOUNDATION_NON_AGENT_BILLING'
...
def test_query_date_is_same_as_backdated_date_for_events_in_metered_daily_usage_fact_table_for_digi_foundation_non_agent():
    registration_type = 'REFINED'
    table_name = 'DIGI_FOUNDATION_NON_AGENT_BILLING'
...
def test_duplicate_records_in_metered_daily_usage_fact_table_for_digi_foundation_non_agent():
    registration_type = 'REFINED'
    table_name = 'DIGI_FOUNDATION_NON_AGENT_BILLING'
