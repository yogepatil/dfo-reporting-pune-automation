# @Author  : Yogesh Patil
# @Time    : 28/08/2023
# @File    : test_018_message_tags_suite_view_count_validation.py
...
# ----------------------------- SUITE VIEW - ATTACHED_ONLY_MESSAGE_TAG_VIEW_V001 COUNT ----------------------------#
def test_suite_attached_only_message_tag_view_v001_record_validation():
